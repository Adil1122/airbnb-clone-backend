...
let SeedService = class SeedService {
    ...
    async seedDestinations() {
        const destinationData = [
            { name: 'Peshawar', region: 'Khyber Pakhtunkhwa', imageUrl: 'https://images.unsplash.com/photo-1627311747833-255d654f5c9e?auto=format&fit=crop&w=100&q=80', type: 'nearby' },
            { name: 'Mardan', region: 'Khyber Pakhtunkhwa', imageUrl: 'https://images.unsplash.com/photo-1623151329243-7f6a6f6959da?auto=format&fit=crop&w=100&q=80', type: 'nearby' },
        ...
        const basePropertyData = [
            {
                ...
                allowPets: true,
                hostName: 'Pichaya',
                hostImage: 'https://i.pravatar.cc/150?u=pichaya',
                ...
                images: [
                    { category: 'Living Room', url: 'https://picsum.photos/seed/villa1/800/800' },
                    { category: 'Full kitchen', url: 'https://picsum.photos/seed/villa2/800/800' },
                    { category: 'Bedroom 1', url: 'https://picsum.photos/seed/villa3/800/800' },
                    { category: 'Bathroom 1', url: 'https://picsum.photos/seed/villa4/800/800' },
                ]
            },
            {
                ...
                allowPets: true,
                hostName: 'Somchai',
                hostImage: 'https://i.pravatar.cc/150?u=somchai',
                ...
                guestFavoriteDesc: '',
                images: [
                    { category: 'Living Room', url: 'https://picsum.photos/seed/farm1/800/800' },
                    { category: 'Full kitchen', url: 'https://picsum.photos/seed/farm2/800/800' },
                    { category: 'Bedroom 1', url: 'https://picsum.photos/seed/farm3/800/800' },
                    { category: 'Bathroom 1', url: 'https://picsum.photos/seed/farm4/800/800' }
                ]
            },
            {
                ...
                allowPets: true,
                hostName: 'Ahmed',
                hostImage: 'https://i.pravatar.cc/150?u=ahmed',
                hostBio: 'Traditional Pakistani host welcoming you to historic Lahore.',
                hostSince: '2015',
                description: 'Beautiful traditional house in the heart of Lahore. Experience real culture and hospitality.',
                hasGreatLocation: true,
                greatLocationDesc: 'Near all historic landmarks.',
                hasFastWifi: true,
                fastWifiDesc: '100 Mbps stable connection.',
                hasGuestFavorite: true,
                guestFavoriteDesc: 'Highly rated for authentic experience.',
                images: [
                    { category: 'Living Room', url: 'https://picsum.photos/seed/lahore1/800/800' },
                    { category: 'Bedroom 1', url: 'https://picsum.photos/seed/lahore2/800/800' },
                ]
            },
            {
    ...
    async seedReviewsForProperty(propertyId, users) {
        const reviewsData = [
            {
    ...
    async seedRulesForProperty(propertyId, maxGuests) {
        ...
        if (houseRulesCat) {
            rulesToCreate.push({ propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: `Check-in after ${checkInTime}`, displayType: 'icon_text', sortOrder: 1 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: `Checkout before ${checkoutTime}`, displayType: 'icon_text', sortOrder: 2 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: `${maxGuests} guests maximum`, displayType: 'icon_text', sortOrder: 3 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: allowSmoking ? 'Smoking allowed' : 'No smoking', isPositive: allowSmoking, displayType: 'checkbox', sortOrder: 4 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: allowPets ? 'Pets allowed' : 'No pets', isPositive: allowPets, displayType: 'checkbox', sortOrder: 5 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: allowParties ? 'Parties allowed' : 'No parties or events', isPositive: allowParties, displayType: 'checkbox', sortOrder: 6 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: 'Suitable for children (2-12 years)', isPositive: true, displayType: 'checkbox', sortOrder: 7 }, { propertyId, categoryId: houseRulesCat.id, categoryName: 'House rules', categoryIcon: 'Home', title: 'Suitable for infants', isPositive: true, displayType: 'checkbox', sortOrder: 8 });
        }
        const safetyCat = categoryMap.get('Safety & property');
        if (safetyCat) {
            rulesToCreate.push({ propertyId, categoryId: safetyCat.id, categoryName: 'Safety & property', categoryIcon: 'Shield', title: 'Smoke alarm', description: 'Smoke alarm is present and functional', isPositive: true, displayType: 'checkbox', sortOrder: 1 }, { propertyId, categoryId: safetyCat.id, categoryName: 'Safety & property', categoryIcon: 'Shield', title: 'Carbon monoxide alarm', description: 'Carbon monoxide alarm is present', isPositive: true, displayType: 'checkbox', sortOrder: 2 }, { propertyId, categoryId: safetyCat.id, categoryName: 'Safety & property', categoryIcon: 'Shield', title: 'Security camera(s)', description: 'Recording devices may be present on the property', isPositive: true, displayType: 'checkbox', sortOrder: 3 }, { propertyId, categoryId: safetyCat.id, categoryName: 'Safety & property', categoryIcon: 'Shield', title: 'Pool', description: hasPool ? 'Property has a pool available for guest use' : 'No pool on property', isPositive: hasPool, displayType: 'checkbox', sortOrder: 4 });
        }
        const cancelCat = categoryMap.get('Cancellation policy');
        if (cancelCat) {
            rulesToCreate.push({ propertyId, categoryId: cancelCat.id, categoryName: 'Cancellation policy', categoryIcon: 'Calendar', title: cancelPolicy.name, description: cancelPolicy.desc, isPositive: true, displayType: 'text_only', sortOrder: 1 }, { propertyId, categoryId: cancelCat.id, categoryName: 'Cancellation policy', categoryIcon: 'Calendar', title: 'Check-in starts at', description: checkInTime, isPositive: true, displayType: 'text_only', sortOrder: 2 });
        }
        const gettingAroundCat = categoryMap.get('Getting around');
        if (gettingAroundCat) {
            rulesToCreate.push({ propertyId, categoryId: gettingAroundCat.id, categoryName: 'Getting around', categoryIcon: 'Car', title: 'Free parking on premises', description: 'Private parking available on site at no extra cost', isPositive: true, displayType: 'checkbox', sortOrder: 1 }, { propertyId, categoryId: gettingAroundCat.id, categoryName: 'Getting around', categoryIcon: 'Car', title: 'Public transport nearby', description: 'BTS Skytrain station within 10 minutes walking distance', isPositive: true, displayType: 'checkbox', sortOrder: 2 });
        }
